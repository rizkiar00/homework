...
func NewRouter(params RouterParams) *echo.Echo {
	...
	RegisterHandlersWithOptions(e, handler, RegisterHandlersOptions{
		OperationMiddlewares: map[string][]echo.MiddlewareFunc{
			...
			"VerifyEmail":        authRateLimitMiddleware(params.Config.HTTP, params.Redis),
			"ResendVerification": authRateLimitMiddleware(params.Config.HTTP, params.Redis),
			"ForgotPassword":     authRateLimitMiddleware(params.Config.HTTP, params.Redis),
			"ResetPassword":      authRateLimitMiddleware(params.Config.HTTP, params.Redis),
